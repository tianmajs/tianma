...
describe('tianma private logic',function (){
    describe('toCamel()',function (done){
        it('should return camel string',function (done){
    ...
    describe('load plugins',function (){
        it('should find pugins',function (done){
            var toCamelFn = tianma.__get__('toCamel');
        ...
        it('should have plugin methods',function (done){
